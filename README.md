...
- [better-writing](https://github.com/forjd/better-writing) - Rewrites and reviews prose to remove AI-writing patterns while keeping the writer's voice and every fact; missing details become placeholders, not inventions. Includes an eval harness. *By [@forjd](https://github.com/forjd)*
