...
- [story-skills](https://github.com/danjdewhurst/story-skills) - 16 Agent Skills for planning, tracking, and drafting fiction in markdown: story setup, worldbuilding, characters, plot and scene craft, chapter writing, revision, series continuity, and submission, plus a CLI that checks continuity. Installable as Codex and Claude Code plugins. *By [@danjdewhurst](https://github.com/danjdewhurst)*
